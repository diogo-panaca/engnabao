...
CREATE TABLE IF NOT EXISTS atletas (
	...
	nome_atleta VARCHAR(128) CHARACTER SET uft8 NOT NULL
);

CREATE TABLE IF NOT EXISTS competicoes (
	id_competicao INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	nome_competicao VARCHAR(128) CHARACTER SET uft8 NOT NULL,
	ano_competicao SMALLINT NOT NULL,
	local_competicao VARCHAR(128) CHARACTER SET uft8 NOT NULL
);
...
CREATE TABLE IF NOT EXISTS louvores (
	...
	lugar NUMBER(1, 0) NOT NULL,
	modalidade VARCHAR(128) CHARACTER SET uft8 NOT NULL,
	designacao VARCHAR(128) CHARACTER SET uft8 NOT NULL,
	CONSTRAINT PRIMARY KEY (id_atleta, id_competicao),
